<? if(isset($view_model)): ?>
    <div class="cms-tabs-container">
        ...
        <a class="cms-tab <?= $view_model->topper->active_tab == 3 ? 'cms-tab-active' : '' ?>" href="/cms/yummy/restaurant/add">Add Restaurant</a>
    </div>
<? else: ?>
    <div class="cms-tabs-container">
        ...
        <a class="cms-tab" href="/cms/yummy/restaurant/add">Add Restaurant</a>
    </div>  
<? endif; ?>