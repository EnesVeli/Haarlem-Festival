...
<div class="cms-tabs-container">
    ...
    <a class="cms-tab <?= $view_model->topper->active_tab == 1 ? 'cms-tab-active' : '' ?>" href="/cms/jazz/hero">Hero</a>
    <a class="cms-tab <?= $view_model->topper->active_tab == 2 ? 'cms-tab-active' : '' ?>" href="/cms/jazz/intro">Intro</a>
