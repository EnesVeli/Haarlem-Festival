                                ...
                                <? foreach($view_model->users as $user): ?>
                                    <tr>
                                        <th>
                                            ...
                                            <? else: ?>
                                                <div class="cms-res-list-image-container">*</div>
                                            <? endif; ?>          
                                        </th>
                ...
                <? if($view_model->total_page_number > 1): ?>   
                    ...
                    <div class="cms-res-list-pages-container">
                        ...
                        <? if($view_model->cur_page != $view_model->total_page_number - 1):?>
                            ...
                            <button class="cms-res-list-page-button cms-res-list-page-button-unsel" onclick="pageButtonClick(<? echo $view_model->total_page_number - 1;?>)">&gt;&gt;</button>
                        <? endif; ?>
                    </div>
                <? endif; ?>
            <? else: ?>
...
<script type="text/javascript">
    ...
    let sort_field = <? echo $view_model->sorting; ?>;
    let sort_order = <? echo $view_model->sort_order; ?>;

    let cur_page = <? echo $view_model->cur_page; ?>;
    let total_page_number = <? echo $view_model->total_page_number; ?>;
    ...
    // Select current page
    if(total_page_number > 1) document.getElementById("page-" + cur_page).className = "cms-res-list-page-button cms-res-list-page-button-sel";

    function sortingOptionClick(sender){
        let uri = '/cms/user?'; // Set base for uri
    ...
    function pageButtonClick(page = 0){
        ...
        let uri = '/cms/user?sort='; // Set base for uri
