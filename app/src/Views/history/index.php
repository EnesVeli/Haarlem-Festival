    ...
    <div class="container">
        <div class="golden-city-grid">
            ...
            <div class="golden-city-images">
                <img src="/assets/images/grote-markt.jpg" alt="Grote Markt" class="city-image">
                <img src="/assets/images/historic-buildings.jpg" alt="Historic Buildings" class="city-image">
            </div>
        </div>
    </div>
</section>
