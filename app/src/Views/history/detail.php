...
<!-- HERO SECTION -->
<section class="detail-hero" style="background-image: url('/assets/css/uploads/history/<?= htmlspecialchars($viewModel->heroImage) ?>');">
    <div class="container">
    ...
    <div class="container">
        ...
        <div class="photo-gallery">
            <?php foreach ($viewModel->gallery as $image): ?>
                <img src="/assets/css/uploads/history/<?= htmlspecialchars($image['image_path']) ?>" 
                    ...
                    <?php elseif ($section['section_type'] === 'special'): ?>
                        <div class="special-content-box">
                            ...
                            <?php if (!empty($section['image_path'])): ?>
                                <img src="/assets/css/uploads/history/<?= htmlspecialchars($section['image_path']) ?>" 
